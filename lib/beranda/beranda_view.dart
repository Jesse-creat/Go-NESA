...
class _BerandaPageState extends State<BerandaPage> {
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: [Color(0xfffd0c0c), Color(0xffff0c0c)],
        ),
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                _buildGopayMenuItem(asset: "assets/icons/icon_transfer.png", text: "Transfer", onTap: () {}),
                _buildGopayMenuItem(asset: "assets/icons/icon_scan.png", text: "Scan QR", onTap: () {}),
                _buildGopayMenuItem(asset: "assets/icons/icon_saldo.png", text: "Isi Saldo", onTap: () async {
                  await Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => IsiSaldoView()),
                  );
                  // Perbarui tampilan saldo setelah kembali dari halaman isi saldo
                  _updateBalanceDisplay();
                }),
                _buildGopayMenuItem(asset: "assets/icons/icon_menu.png", text: "Lainnya", onTap: () {}),
              ],
            ),
          ),
        ],
  ...
  Widget _rowGojekService(GojekService gojekService) {
    return InkWell(
      onTap: () {
        if (gojekService.title == "GO-RIDE") {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => GoRideView()),
          );
        }
      },
      child: Column(
