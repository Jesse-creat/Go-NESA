...
class GoRideView extends StatefulWidget {
  ...
  @override
  State<GoRideView> createState() => _GoRideViewState();
}
...
class _GoRideViewState extends State<GoRideView> {
  ...
  void _calculateDummyPrice() {
    if (_selectedFrom != null && _selectedTo != null) {
      ...
      final random = Random();
      final randomPrice = (15000 + random.nextInt(25001)).toDouble();
      setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(AppLocale.pesanGoRide.getString(context)),
        elevation: 0,
      ),
      body: Column(
        children: [
  ...
  Widget _buildLocationDropdown({
    ...
    return DropdownButtonFormField<String>(
      ...
      decoration: InputDecoration(
        prefixIcon: Icon(icon, color: GoNesaPalette.menuRide),
        labelText: hint,
