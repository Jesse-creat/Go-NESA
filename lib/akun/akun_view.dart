        ...
        children: [
          Expanded(
            child: _buildStatCard(
              ...
              title: 'Voucher',
              value: VoucherData.claimedVouchers.length.toString(),
              subtitle: 'Aktif',
              color: Colors.orange,
          ...
          Expanded(
            child: _buildStatCard(
              ...
              title: 'Pesanan',
              value: OrderData.history.length.toString(),
              subtitle: 'Total',
              color: Colors.blue,
      ...
      child: Column(
        children: [
          ...
          _buildMenuItem(
            icon: Icons.local_offer_rounded,
            title: 'Voucher Saya',
            subtitle: '${VoucherData.claimedVouchers.length} voucher tersedia',
            color: Colors.orange,
            gradient: [Colors.orange.shade400, Colors.orange.shade600],
            onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => const VoucherSayaView())),
          ),
          _buildDivider(),
          _buildMenuItem(
